function SearchInput({ setOpenSearch }) {
    return (
        <div className="flex bg-white rounded-[25px] w-[446px] overflow-hidden">
            <div
                onClick={() => setOpenSearch(false)}
                className="p-3 cursor-pointer bg-[#0D4C93] rounded-[25px] inline-block"
            >
                <svg
            ...
            <input
                ...
                className="placeholder:text-[12px]  pl-[26px] placeholder:text-black focus:outline-none"
            />
        </div>
    );
}
